...
var generateOutputTransactions = function(poolRecipient, recipients, rpcData){
    ...
    if (rpcData.backbone.payee) { //TODO(Narek): Confirm if this is the expected payee. changed 'rpcData.payee->rpcData.backbone.payee'to match the block template
	var payeeReward = 0;
...
exports.CreateGeneration = function(rpcData, publicKey, extraNoncePlaceholder, reward, txMessages, recipients, auxMerkleTree){
    ...
    var txInSequence = 1; //TODO(Narek): Confirm. Was 0 (seems always) set to 1
